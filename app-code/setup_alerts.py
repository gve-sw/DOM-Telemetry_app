...
import ansible_runner, yaml, requests
...
def sync_grafana():
    ...
    for media_type_info in total_info:
        ...
        # go into each panel/graph to add query and alert for that media type
        for panel in dashboard_json['panels']:
            ...
            alert_condition = {
                ...
                "reducer": {
                    "params": [],
                    "type": grafana_alertcondition_aggregation
                },
                "type": "query"
            }
            ...
            if 'alert' not in panel.keys():
                ...
                alert_condition['operator']['type'] = 'and'
                ...
                if condition_exists == False:
                    ...
                    alert_condition['evaluator']['params'][0] = low_alarm
                    alert_condition['evaluator']['params'][1] = high_alarm
                    alert_condition['operator']['type'] = 'or'
                    update = True
